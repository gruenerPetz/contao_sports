...
$GLOBALS['TL_DCA']['tl_content']['palettes']['cs_events']         = '{type_legend},type,headline;{cs_events_legend},cs_calendar;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
...
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_content']['cs_table_calendar'],
	'inputType'               => 'select',
	'foreignKey'              => 'tl_cs_calendar.title',
	'sql'                     => "int(10) unsigned NOT NULL default '0'",
	'eval'                    => array('mandatory'=>true),
