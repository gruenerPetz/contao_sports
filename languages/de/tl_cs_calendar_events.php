...
/**
 * This is the language file (de) for tl_cs_calendar_events.
 *
...
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['new'][0] = 'Neues Event';
...
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['featured'][0] = 'Hervorheben';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['featured'][1] = 'Wählen Sie, ob dieses Event hervorgehoben dargstellt werden soll.';

$GLOBALS['TL_LANG']['tl_cs_calendar_events']['color'][0] = 'Farbe';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['color'][1] = 'Mit welcher Farbe soll das Event hervorgehoben werden?';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['color']['gold'] = 'Gold';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['color']['red'] = 'Rot';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['color']['blue'] = 'Blau';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['color']['black'] = 'Schwarz';

$GLOBALS['TL_LANG']['tl_cs_calendar_events']['alias'][0] = 'Event-Alias';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['alias'][1] = 'Der Event-Alias ist eine eindeutige Referenz, die anstelle der numerischen Event-ID aufgerufen werden kann.';

$GLOBALS['TL_LANG']['tl_cs_calendar_events']['author'][0] = 'Autor';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['author'][1] = 'Hier können Sie den Autor des Events ändern.';

$GLOBALS['TL_LANG']['tl_cs_calendar_events']['location'][0] = 'Veranstaltungsort';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['location'][1] = 'Hier können Sie den Veranstaltungsort eingeben.';

$GLOBALS['TL_LANG']['tl_cs_calendar_events']['startDate'][0] = 'Startdatum';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['startDate'][1] = 'Bitte geben Sie das Startdatum gemäß des globalen Datumsformats ein.';
...
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['gameReport'][0] = 'Spielbericht';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['gameReport'][1] = 'Hier können Sie den Spielbericht eingeben.';

$GLOBALS['TL_LANG']['tl_cs_calendar_events']['published'][0] = 'Event veröffentlichen';
$GLOBALS['TL_LANG']['tl_cs_calendar_events']['published'][1] = 'Dieses Event auf der Webseite anzeigen.';